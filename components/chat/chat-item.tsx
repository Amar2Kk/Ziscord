...
const roleIconMap = {
    ...
    ADMIN: <Crown className="w-4 h-4 ml-1 text-[#FFC30B]" />,
};
...
export const ChatItem = ({
    ...
    return (
        <div className="relative flex items-center w-full p-4 transition group hover:bg-black/5">
            ...
            {canDeleteMessage && (
                <div className="absolute hidden p-1 bg-white border rounded-sm group-hover:flex item-center gap-x-2 -top-2 right-5 dark:bg-zinc-800">
                    {canEditMessage && (
                        <ActionTooltip label="Edit">
                            <Edit
                                onClick={() => setIsEditing(true)}
                                className="w-4 h-4 ml-auto transition cursor-pointer text-zinc-500 hover:text-orange-400 dark:hover:text-orange-400"
                            />
                        </ActionTooltip>
                    )}
                    <ActionTooltip label="Delete">
                        <Trash
                            ...
                            className="w-4 h-4 ml-auto transition cursor-pointer text-zinc-500 hover:text-red-500 dark:hover:text-red-500"
                        />
                    </ActionTooltip>
                </div>
            )}
